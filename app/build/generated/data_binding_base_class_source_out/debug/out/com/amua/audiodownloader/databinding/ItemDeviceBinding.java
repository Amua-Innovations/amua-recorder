...
public final class ItemDeviceBinding implements ViewBinding {
  ...
  private ItemDeviceBinding(@NonNull LinearLayout rootView, @NonNull TextView deviceAddress,
      @NonNull TextView deviceName, @NonNull TextView deviceRssi) {
  ...
  public static ItemDeviceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemDeviceBinding((LinearLayout) rootView, deviceAddress, deviceName, deviceRssi);
    }
